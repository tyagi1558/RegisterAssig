...
const MainPage = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between p-4 md:p-8 bg-gradient-to-r from-amber-100 via-blue-100 to-blue-200">
      {/* Left Section */}
      ...
      {/* Right Section */}
      <div className="relative md:w-1/2 flex px-4">
        {/* Main Image */}
        ...
        {/* Overlay Buttons */}
        <div className="absolute right-4 top-8 flex flex-col space-y-4 md:space-y-8">
